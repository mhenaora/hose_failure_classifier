# hose-failure-classifier guide installation
...
activate hose_failure_classifier
```
...
To move beyond notebook prototyping, all reusable code should go into the `hose_failure_classifier/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `hose_failure_classifier` folder and use the modules inside your notebooks :
